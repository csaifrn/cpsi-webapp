            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex flex-row   mt-2 gap-4 ">
                    <div className="flex flex-col gap-1 flex-1">
                        ...
                        <Input type="text" {...register("dataNascimento")}  placeholder="Dia / Mes / Ano"
                        ref={withMask('99/99/9999', {placeholder: '_', showMaskOnHover: false})}
                        className="flex pl-1  w-full h-8 text-gray-800 text-xs border-b-2 border-t-white border-r-white border-l-white border-b-gray-300 text-shadow-none rounded-0xl" />
