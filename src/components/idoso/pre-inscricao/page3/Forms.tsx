    ...
    return (
        <div className="font-courier-prime w-80 max-w-md mx-auto flex flex-col justify-center ">
            ...
            <div className="flex flex-col mt-2 gap-1 ">
                ...
                <Input type="text" placeholder="Digite o Nome do idoso" className="flex pl-1  w-full h-8 text-gray-800 text-xs border-b-2 border-t-white border-r-white border-l-white border-b-gray-300 text-shadow-none rounded-0xl" />
            </div>
            <div className="flex flex-row   mt-2 gap-4 ">
                <div className="flex flex-col gap-1 flex-1">
                    <Label className="text-principal-blue text-left">Data de nascimento</Label>   
                    <Input type="text" placeholder="Dia / Mes / Ano" className="flex pl-1  w-full h-8 text-gray-800 text-xs border-b-2 border-t-white border-r-white border-l-white border-b-gray-300 text-shadow-none rounded-0xl" />
                </div>
            ...
            <div className="flex flex-col gap-1 w-80">
                ...
                <Input type="text" placeholder="Digite o Nome do contato de emergência" className="flex pl-0.5 w-full h-8 text-gray-800 text-xs border-b-2 border-t-white border-r-white border-l-white border-b-gray-300 text-shadow-none rounded-0xl" />
            </div>
            <div className="flex flex-col gap-1 mt-2 w-80">
                <Label className="text-principal-blue text-left">Telefone do contato</Label>
                <Input type="text" placeholder="Número do telefone do contato de emergência" className="flex pl-0.5 w-full h-8 text-gray-800 text-xs border-b-2 border-t-white border-r-white border-l-white border-b-gray-300 text-shadow-none rounded-0xl" />
            </div>
        </div>
    );
}
