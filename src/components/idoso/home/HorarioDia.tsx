    ...
    return (        
        <div className="border border-gray-300 rounded-lg m-4">
          ...
          <Table className="font-courier-prime">
            <TableHeader>
              <TableRow className="border-b border-principal-blue">
                <TableHead className="text-center text-sm w-[150px] h-[50px] text-gray-700 font-semibold">ATIVIDADE</TableHead>
                <TableHead className="text-center text-sm *:w-[150px] h-[50px] border-x border-principal-blue text-gray-700 font-semibold">HORÁRIO</TableHead>
            ...
            <TableBody>
              ...
              <TableRow className="border-b border-principal-blue">
                ...
                <TableCell className="text-center text-sm border-x border-principal-blue w-[150px] h-[50px]">7:00-7:45 <br/> Sala 1</TableCell>
              ...
              <TableRow className="border-b border-principal-blue">
                ...
                <TableCell className="text-center text-sm border-x border-principal-blue w-[150px] h-[50px]">7:45-8:00 <br/> Sala 2</TableCell>
              ...
              <TableRow>
                ...
                <TableCell className="text-center border-x text-sm border-principal-blue w-[150px] h-[50px]">9:00-10:15 <br/> Sala 3</TableCell>
