...
export default function page() {
  return (
    <section className=" bg-white">
      ...
      <CardHome>
        <div className="py-4 text-gray-900 font-courier-prime">
          <div className="flex items-center text-lg font-semibold">
            <Button
              variant="ghost"
              size="icon"
              className="mr-2 p-0 h-auto w-auto"
            >
        ...
        <Card className="w-full bg-white shadow-lg mb-8 font-courier-prime text-lg border border-principal-blue rounded-md p-0">
          ...
          <CardFooter className="border-t border-principal-blue px-7 py-6 text-lg text-gray-900 flex flex-col items-start">
            <p className="font-bold mb-1 font-courier-prime">
